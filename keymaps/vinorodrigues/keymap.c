...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_NUML] = LAYOUT_ansi_all(
        ...
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,          KC_P1,   KC_P2,   KC_P3,   _______,
    ...
    [MAC_FN] = LAYOUT_ansi_all(
        ...
        _______,          _______, _______, _______, Q6_VRSN, _______, NK_TOGG, _______, _______, _______, _______,          _______,          _______,          _______, _______, _______, _______,
